...
<h3 style="text-align: center; font-weight: normal; margin-top: 2em; margin-bottom: 2em">Rule based chat bot that is integrated with an AI agent that plays backgammon using MinMax search method.</h3>
  <p align="left">
